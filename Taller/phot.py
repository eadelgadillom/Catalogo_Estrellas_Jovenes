...
carpeta = '/media/giova/5245170f-18ef-4ebc-832a-edac8afa51eb1/2024/TEC_New/SFRs/IC348/Campo1/r26510080/ch1/pbcd/'
...
import numpy as np
archivo_catalogo = "/media/giova/5245170f-18ef-4ebc-832a-edac8afa51eb1/2024/TEC_New/SFRs/IC348/Campo1/r26510080/ch1/pbcd/cat" 
...
#----# Se guardan las tablas como archivos .csv
  ...
  for j in filtro_final[foc]:
    ...
    counter += 1
  final_obs_table.write(f'/media/giova/5245170f-18ef-4ebc-832a-edac8afa51eb1/2024/TEC_New/SFRs/IC348/Campo1/r26510080/ch1/pbcd/Table_{foc}.csv', overwrite=True)    
